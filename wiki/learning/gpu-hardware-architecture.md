...
**Source**: AI Systems Performance Engineering, Chapter 2 [src](raw/AI%20Systems%20Performance%20Engineering.pdf)
...
### NVLink 5 (Blackwell)
- 1.8 TB/s bidirectional aggregate bandwidth per GPU (2× Hopper's NVLink 4)
...
- Vs 72-GPU H100 cluster over InfiniBand: NVLink bandwidth ~20× higher, latency ~5× lower
...
- RDMA on TCP/IP: 5-10× higher latency, limited to ~100 Gbps without RoCE
...
- [Communication Wall](moe-communication-wall.md) — Why NVLink bandwidth matters for MoE
- [Megatron-Core MoE](megatron-core-moe-scalable-training.md) — GB200/GB300 performance numbers
