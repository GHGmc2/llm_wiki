...
![RL algorithms overview — from MDPs to policy gradient](../assets/rl_algorithms_overview.png)

*Figure: The RL algorithm landscape — from value-based (Bellman, TD, Q-learning) through policy-based (REINFORCE, actor-critic) to modern LLM RL (PPO, GRPO). [src](../assets/rl_algorithms_overview.png)*
